...
<html>
    ...
    <body>
        ...
        <center><img src="..\images\logo2.png" height=80px></center>
                ...
                <span><p> Don't have an account? <a href="create account.php">Signup</a>.<p></span>
            </form>
        </div>
        <?php
                if(isset($_POST['submit']))
                {
                    ...
                    $query=mysqli_query($con,"select * from tasker where email='$email' and password='$password'");
